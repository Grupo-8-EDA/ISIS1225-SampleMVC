...
def printMenu():
    ...
    print("2- Cargar Tags")
    print("3- Cargar Books Tags") # TO-DO: Modificaciones para completar el laboratorio 1
    print("0- Salir")
...
while True:
    ...
    elif int(inputs[0]) == 3: # TO-DO: Modificaciones para completar el laboratorio 1
